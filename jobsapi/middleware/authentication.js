...
const auth = (req, res, next) => {
    ...
    //if the Authorization header is present and correctly formatted, the code extracts the JWT from the header by splitting it at the space (' ') and taking the second part (the token).
